...
yt.add_particle_filter('angle_II', function=angle_II, filtered_type='PartType0', requires=['phi'])
...
yt.add_particle_filter('angle_III', function=angle_III, filtered_type='PartType0', requires=['phi'])
...
yt.add_particle_filter('angle_IV', function=angle_IV, filtered_type='PartType0', requires=['phi'])
...
yt.add_particle_filter('angle_V', function=angle_V, filtered_type='PartType0', requires=['phi'])
...
yt.add_particle_filter('angle_VI', function=angle_VI, filtered_type='PartType0', requires=['phi'])
...
##apply angle filters
#p1 = yt.PhasePlot(sp2, ('angle_I', 'particle_position_spherical_radius'), \
#    ('angle_I', 'phi'), ('angle_I', 'mass'), weight_field=None)
#p1.set_unit(('angle_I', 'mass'), 'Msun')
#p1.set_unit(('angle_I', 'particle_position_spherical_radius'), 'kpc')
...
#p2 = yt.PhasePlot(sp2, ('angle_II', 'particle_position_spherical_radius'), \
#    ('angle_II', 'phi'), ('angle_II', 'mass'), weight_field=None)
#p2.set_unit(('angle_II', 'mass'), 'Msun')
#p2.set_unit(('angle_II', 'particle_position_spherical_radius'), 'kpc')
...
#p3 = yt.PhasePlot(sp2, ('angle_III', 'particle_position_spherical_radius'), \
#    ('angle_III', 'phi'), ('angle_III', 'mass'), weight_field=None)
#p3.set_unit(('angle_III', 'mass'), 'Msun')
#p3.set_unit(('angle_III', 'particle_position_spherical_radius'), 'kpc')
...
#p5 = yt.PhasePlot(sp2, ('angle_V', 'particle_position_spherical_radius'), \
#    ('angle_V', 'phi'), ('angle_V', 'mass'), weight_field=None)
#p5.set_unit(('angle_V', 'mass'), 'Msun')
#p5.set_unit(('angle_V', 'particle_position_spherical_radius'), 'kpc')
...
#p6 = yt.PhasePlot(sp2, ('angle_VI', 'particle_position_spherical_radius'), \
#    ('angle_VI', 'phi'), ('angle_VI', 'mass'), weight_field=None)
#p6.set_unit(('angle_VI', 'mass'), 'Msun')
#p6.set_unit(('angle_VI', 'particle_position_spherical_radius'), 'kpc')
